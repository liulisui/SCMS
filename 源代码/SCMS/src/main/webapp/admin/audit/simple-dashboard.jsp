            ...
            <div class="col-md-3 mb-3">
                <div class="card dashboard-card stat-card text-center">
                    <div class="card-body">
                        ...
                        <h3 class="mb-0">${statistics.totalLogs}</h3>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card dashboard-card stat-card success text-center">
                    <div class="card-body">
                        <div class="display-6 mb-2">
                            <i class="fas fa-check-circle"></i>
                        </div>
                        <h5 class="card-title">今日登录</h5>
                        <h3 class="mb-0">${statistics.successfulLogins}</h3>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card dashboard-card stat-card warning text-center">
                    <div class="card-body">
                        <div class="display-6 mb-2">
                            <i class="fas fa-database"></i>
                        </div>
                        <h5 class="card-title">数据操作</h5>
                        <h3 class="mb-0">${statistics.dataOperations}</h3>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="col-md-4 text-center">
                                <a href="${pageContext.request.contextPath}/admin/enhanced-audit?action=search" 
                                   class="btn btn-success action-btn w-100">
                                    ...
                                    <h6>查询日志</h6>
                                    <small class="text-light">按条件搜索日志</small>
                                </a>
                            </div>
                            ...
                            <div class="col-md-4 text-center">
                                <a href="${pageContext.request.contextPath}/admin/enhanced-audit?action=statistics" 
                                   class="btn btn-info action-btn w-100">
                                    ...
                                    <h6>统计分析</h6>
                                    <small class="text-light">查看详细统计</small>
                                </a>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <c:forEach var="log" items="${recentLogs}" varStatus="status">
                                            <c:if test="${status.index < 5}">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge bg-${log.action.contains('FAILED') ? 'danger' : 
