    ...
    <div class="container">
        ...
        <% if (department != null) { %>
            <div class="status-info">
                <h4>部门状态信息</h4>
                <p>
                    当前状态：<strong><%= "active".equals(department.getStatus()) ? "启用" : "禁用" %></strong>
                    | ID：<%= department.getId() %>
                    | 创建时间：<%= department.getCreatedAt() != null ? 
                        department.getCreatedAt().format(java.time.format.DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm")) : "未知" %>
                </p>
            </div>
                ...
                <form method="post" action="${pageContext.request.contextPath}/admin/department">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="departmentCode" name="departmentCode" 
                                   ...
                                   value="<%= department.getDepartmentCode() != null ? department.getDepartmentCode() : "" %>"
                    ...
                    <div class="form-group">
                        <label for="departmentType" class="form-label">
                            ...
                            <option value="academic" <%= "academic".equals(department.getDepartmentType()) ? "selected" : "" %>>教学部门</option>
                            <option value="administrative" <%= "administrative".equals(department.getDepartmentType()) ? "selected" : "" %>>行政部门</option>
                            <option value="other" <%= "other".equals(department.getDepartmentType()) ? "selected" : "" %>>其他</option>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" name="description" class="form-textarea" 
                                  maxlength="500" placeholder="请输入部门描述（可选）"><%= department.getDescription() != null ? department.getDescription() : "" %></textarea>
